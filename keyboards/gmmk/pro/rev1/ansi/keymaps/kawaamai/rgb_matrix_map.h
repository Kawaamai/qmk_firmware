 ...
 */
    ...
    // Custom RGB Colours
    // const HSV hsv_cl_brass  = {43,  51,  88};
    // const HSV hsv_cl_white  = {0,   0,   0};
    // const HSV hsv_cl_cyan   = {163, 51,  88}
    // const HSV hsv_cl_purple = {283, 51,  88}
    #define _COLOR_BRASS  255, 234, 51
    #define _COLOR_WHITE 255, 255, 255
    #define _COLOR_CYAN 110, 225, 193
    #define _COLOR_PURP 193, 110, 225
    ...
    enum led_location_map {
        ...
        LED_L1, // 67, LED, l01
        LED_R1, // 68, LED, l11
        LED_F13, // 69, Prt, k97  -- remapped to TG(_GAME), called F13
        LED_L2, // 70, LED, l02
        LED_R2, // 71, LED, l12
        LED_HOME, // 72, Del, k65
        LED_L3, // 73, LED, l03
